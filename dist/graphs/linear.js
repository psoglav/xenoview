...
class LinearGraph extends base_1.default {
    constructor(container, data, opts) {
        ...
        this.CHART_STROKE_WIDTH = 1;
        this.CHART_STROKE_COLOR = '#ffffff99';
        this.CHART_POINTER_COLOR = '#aaaaff99';
        this.CHART_PRICE_SEGMENTS = 6;
        this.GRAPH_LEFT = 0;
    ...
    applyOptions(opts) {
        if (opts.graphStroke) {
            ...
            if (hoverWidth)
                this.CHART_HOVER_STROKE_WIDTH = hoverWidth;
            if (width) {
